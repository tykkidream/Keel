 ...
 * </ul>
 * <p>本接口使用了泛型，使用了通用架构的其它部分：Module层通用类{@link tykkidream.keel.base.sdm.BaseModel BaseModel}。并有默认的实现{@link tykkidream.keel.mybatis.sdm.SimpleDao BaseDaoImpl}，可直接继承使用。</p>
