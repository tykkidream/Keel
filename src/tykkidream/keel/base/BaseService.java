 ...
 * </ul>
 * <p>本接口使用了泛型，使用了通用架构的其它部分：Dao层通用接口{@link tykkidream.keel.base.BaseDao BaseDao}和Module层通用类{@link tykkidream.keel.base.BaseModel BaseModel}。并有默认的实现{@link tykkidream.keel.base.BaseServiceImpl BaseServiceImpl}，可直接继承使用。</p>
 ...
 * @see tykkidream.keel.base.BaseServiceImpl
